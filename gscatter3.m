function [varargout]=gscatter3(x,y,z,g,mrksze,mrkfclr,leg,legloc)
%------------------------------HELP START----------------------------------
...
for i=1:length(gu),
    ...
    h(1,i)=scatter3(x(inds),y(inds),z(inds),'MarkerEdgeColor','k',...
            'MarkerFaceColor',clr{i});
    hold on;
    % if ~iscellstr(clr)&&~ischar(clr)
    %     set(h(1,i),'Color',clr(i,:),'MarkerEdgeColor','k',...
    %         'MarkerFaceColor',mrkfclr(i,:));
    % else
    %     set(h(1,i),'Color',clr{1,i},'MarkerEdgeColor','k', ...
    %         'MarkerFaceColor',mrkfclr{1,i});
    % end;
end;
